...
import { questionsA } from "../Helpers/QuestionBank";
import "../App.css";
import "./Quiz.css";
...
export default function Quiz1() {
  ...
  const nextQuestion = () => {
    if (questionsA[currQuestion].answer === optionChosen) {
      setScore(score + 1);
    }
  ...
  // const getCount = () => {
  //   setCurrQuestion(currQuestion.length - 1);
  // };
          ...
          <div className="container__quiz">
            <div className="container__form-quiz">
              <div className="form__quiz-title">
                {currQuestion === 0 && (
                  <p> 1. {questionsA[currQuestion].prompt}</p>
                )}
                {currQuestion === 1 && (
                  <p> 2. {questionsA[currQuestion].prompt}</p>
                )}
                {currQuestion === 2 && (
                  <p> 3. {questionsA[currQuestion].prompt}</p>
                )}
                {currQuestion === 3 && (
                  <p> 4. {questionsA[currQuestion].prompt}</p>
                )}
                {currQuestion === 4 && (
                  <p> 5. {questionsA[currQuestion].prompt}</p>
                )}
                {currQuestion === 5 && (
                  <p> 6. {questionsA[currQuestion].prompt}</p>
                )}
                {currQuestion === 6 && (
                  <p> 7. {questionsA[currQuestion].prompt}</p>
                )}
                {currQuestion === 7 && (
                  <p> 8. {questionsA[currQuestion].prompt}</p>
                )}
                {currQuestion === 8 && (
                  <p> 9. {questionsA[currQuestion].prompt}</p>
                )}
                {currQuestion === 9 && (
                  <p> 10. {questionsA[currQuestion].prompt}</p>
                )}
              </div>
              ...
              <div className="form__quiz-flex">
                <div class="form__quiz-group">
                  ...
                  >
                    ...
                    {" " + questionsA[currQuestion].optionA}
                  </label>
                </div>
                ...
                <div class="form__quiz-group">
                  ...
                  >
                    ...
                    {" " + questionsA[currQuestion].optionB}
                  </label>
                </div>
                ...
                <div class="form__quiz-group">
                  ...
                  >
                    ...
                    {" " + questionsA[currQuestion].optionC}
                  </label>
                </div>
                ...
                <div class="form__quiz-group">
                  ...
                  >
                    ...
                    {" " + questionsA[currQuestion].optionD}
                  </label>
                </div>
                ...
                <div class="form__quiz-group">
                  ...
                  >
                    ...
                    {" " + questionsA[currQuestion].optionE}
                  </label>
                </div>
              </div>

              <div class="form__button">
                {currQuestion === questionsA.length - 1 ? (
